    ...
    public partial class WorkHistory : System.Web.UI.Page
    {
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            if (EndTime < StartTime)
            {
                ...
                lblDateCheck.Text = "検索終了日をもう一度確認して下さい。";
            }
            else
            {
        ...
        protected void gvTimes_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            if (e.CommandName.Equals("Detail"))
            {
                ...
                work = wt.GetWorkNo(work, work.InTime);
                ...
                if(work.WorkStatus == 0)
                {
                    ...
                    {
                        Server.Transfer("WorkDetail.aspx");
                    }

                    
                }
                else if(work.WorkStatus == 1 || work.WorkStatus == 2)
                {

                    Session["Notice"] = "有給または早退の場合は変更出来ません。";
