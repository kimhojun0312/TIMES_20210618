<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkDetailAdmin.aspx.cs" Inherits="TIMES.WorkDetailAdmin" %>
...
<body>
    ...
    &nbsp;&nbsp;
            ...
            <asp:Label ID="lblDays" runat="server" Text="日　から"></asp:Label>
            <br />
            <br />
            ...
            <asp:Label ID="lblDay" runat="server" Text="日　まで"></asp:Label>
    &nbsp;&nbsp;&nbsp;&nbsp;
            <asp:Button ID="btnSearch" runat="server" class="btn btn-outline-dark" Text="検索" OnClick="btnSearch_Click" />

    <asp:RequiredFieldValidator ID="rfvYear" runat="server" ControlToValidate="ddlYear" Display="None" ErrorMessage="년도를 입력해주세요."></asp:RequiredFieldValidator>
    <asp:RequiredFieldValidator ID="rfvMonth" runat="server" ControlToValidate="ddlMonth" Display="None" ErrorMessage="월을 입력해주세요."></asp:RequiredFieldValidator>
    <asp:RequiredFieldValidator ID="rfvDay" runat="server" ControlToValidate="ddlYear" Display="None" ErrorMessage="일을 입력해주세요."></asp:RequiredFieldValidator>
            <br />
